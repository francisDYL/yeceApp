function navbarSubmenu(e) {
    e > 767 && $(".main-navigation .navbar-nav > li.dropdown").hover(function () {
        var t = $(".dropdown-menu", $(this)).offset().left, i = $(".dropdown-menu", $(this)).width();
...
function ssc_init() {
    if (document.body) {
        var e = document.body, t = document.documentElement, i = window.innerHeight, s = e.scrollHeight;
        if (ssc_root = document.compatMode.indexOf("CSS") >= 0 ? t : e, ssc_activeElement = e, ssc_initdone = !0, top != self) ssc_frame = !0; else if (s > i && (e.offsetHeight <= i || t.offsetHeight <= i) && (ssc_root.style.height = "auto", ssc_root.offsetHeight <= i)) {
    ...
    if (s || (s = 1e3), ssc_directionCheck(t, i), ssc_que.push({
        ...
        var n = function () {
            for (var o = +new Date, a = 0, r = 0, l = 0; l < ssc_que.length; l++) {
                var c = ssc_que[l], d = o - c.start, u = d >= ssc_animtime, h = u ? 1 : d / ssc_animtime;
                ssc_pulseAlgorithm && (h = ssc_pulse(h));
                var p = c.x * h - c.lastX >> 0, f = c.y * h - c.lastY >> 0;
...
function ssc_wheel(e) {
    ...
    var s = e.wheelDeltaX || 0, n = e.wheelDeltaY || 0;
...
function ssc_keydown(e) {
    ...
    var s, n = 0, o = 0, a = ssc_overflowingAncestor(ssc_activeElement), r = a.clientHeight;
    ...
    function e() {
        {
            var e = {
                zoom: 11,
                scrollwheel: !1,
                center: new google.maps.LatLng(33.5823985, -7.6441356),
                styles: [{
                    featureType: "water",
            ...
            new google.maps.Marker({position: new google.maps.LatLng(33.5823985, -7.6441356), map: i, title: "Snazzy!"})
        }
    }
...
$special = $event.special.debouncedresize = {
    setup: function () {
        ...
        var i = this, s = arguments, n = function () {
...
$.fn.imagesLoaded = function (e) {
    ...
    var s = this, n = $.isFunction($.Deferred) ? $.Deferred() : 0, o = $.isFunction(n.notify),
        a = s.find("img").add(s.filter("img")), r = [], l = [], c = [];
    return $.isPlainObject(e) && $.each(e, function (t, i) {
        ...
        var s = t.src, n = $.data(t, "imagesLoaded");
...
var Grid = function () {
    ...
    function a(e) {
        var t = $.data(this, "preview"), i = e.data("offsetTop");
    ...
    var c, d = $("#og-grid"), u = d.children("li"), h = -1, p = -1, f = 0, m = 10, v = $(window), g = $("html, body"),
        y = {
        ...
        }, w = y[Modernizr.prefixed("transition")], b = Modernizr.csstransitions,
    ...
    return l.prototype = {
        create: function () {
            ...
            var e = c.height - this.$item.data("height") - m, t = c.height;
...
!function (e, t, i) {
    ...
    e.HoverDir = function (t, i) {
        ...
        _init: function (t) {
            ...
            this.$el.on("mouseenter.hoverdir, mouseleave.hoverdir", function (i) {
                var s = e(this), n = s.find("div"), o = t._getDir(s, {x: i.pageX, y: i.pageY}), a = t._getStyle(o);
            ...
            var i = e.width(), s = e.height(), n = (t.x - e.offset().left - i / 2) * (i > s ? s / i : 1),
                o = (t.y - e.offset().top - s / 2) * (s > i ? i / s : 1),
                a = Math.round((Math.atan2(o, n) * (180 / Math.PI) + 180) / 90 + 3) % 4;
            return a
        }, _getStyle: function (e) {
            var t, i, s = {left: "0px", top: "-100%"}, n = {left: "0px", top: "100%"}, o = {left: "-100%", top: "0px"},
                a = {left: "100%", top: "0px"}, r = {top: "0px"}, l = {left: "0px"};
            switch (e) {
                case 0:
            ...
            e.fn.applyStyle = this.support ? e.fn.css : e.fn.animate, t.stop().applyStyle(i, e.extend(!0, [], {duration: s + "ms"}))
        }
    };
    var s = function (e) {
    ...
    function i(t, i) {
        var s = this, o = e(s);
        if (s.value === o.attr("placeholder") && o.hasClass(h.customClass)) if (s.value = "", o.removeClass(h.customClass), o.data("placeholder-password")) {
    ...
    var o, a, r = "[object OperaMini]" === Object.prototype.toString.call(window.operamini),
        ...
        c = "placeholder" in document.createElement("textarea") && !r, d = e.valHooks, u = e.propHooks, h = {};
    l && c ? (a = e.fn.placeholder = function () {
        ...
        get: function (t) {
            var i = e(t), s = i.data("placeholder-password");
    ...
    $("#client-carousel").owlCarousel({items: 6, itemsDesktopSmall: 4, itemsTablet: 4, itemsMobile: 2, autoPlay: !0})
}), function () {
    function e() {
    ...
    $(".main-navigation a[href*=#]:not([href=#]), .onPageNav").click(function () {
        if (location.pathname.replace(/^\//, "") === this.pathname.replace(/^\//, "") && location.hostname === this.hostname) {
            var e = $(this.hash);
            if (e = e.length ? e : $("[name=" + this.hash.slice(1) + "]"), e.length) return $(".navbar-collapse.collapse.in").removeClass("in"), $("html,body").animate({scrollTop: e.offset().top - 55}, 1e3, function () {
            }), !1
        }
...
/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && (mobileTest = !0), $(document).on("click", ".navbar-collapse.in", function (e) {
    ...
    $(".flexslider").flexslider({animation: "fade", easing: "swing", controlNav: !1})
}), $(".rotate").textrotator({animation: "fade", separator: ",", speed: 2e3}), function () {
    $(function () {
...
ischrome && (ssc_addEvent("mousedown", ssc_mousedown), ssc_addEvent("mousewheel", ssc_wheel), ssc_addEvent("load", ssc_init)), $("#subscription-form").submit(function (e) {
    e.preventDefault();
    var t = $("#subscription-form"), i = $("#subscribe-button"), s = $("#subscription-response"),
    ...
    var e = $("#testimonials-carousel"), t = $(".review"), i = $("#clientFace");
    e.owlCarousel({
        singleItem: !0, autoPlay: !0, pagination: !1, autoHeight: !0, beforeMove: function (s) {
            var n = e.data("owlCarousel"), o = t[n.currentItem];
